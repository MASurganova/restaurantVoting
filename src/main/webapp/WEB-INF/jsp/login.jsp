...
<div class="container">
    <div class="lead">
        &nbsp;&nbsp;&nbsp;<a href="https://github.com/MASurganova/restaurantVoting">Restaurant voting проект</a> с
        регистрацией/авторизацией и интерфейсом на основе ролей (USER, ADMIN).
        Пользователи должны выбрать ресторан, в котором будут обедать, проголосовав за него,
        выбор происходит через UI (по AJAX) и по REST интерфейсу с базовой авторизацией.
        Администратор создает список ресторанов на каждый день с перечисланием блюд ланча,
        а также может создавать/редактировать/удалять пользователей.
